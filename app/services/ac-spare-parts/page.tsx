...
function ACSparePartsContent() {
  ...
  const handleSearch = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter') {
      ...
      window.location.href = `/services/ac-spare-parts?${params.toString()}`;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 via-white to-neutral-50">
      ...
      <section className="relative bg-gradient-to-br from-primary-50 to-secondary-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto mb-8">
              Premium air conditioner spare parts for all major brands. Genuine parts with warranty and bulk discounts available.
            </p>
        ...
        {/* Decorative Elements */}
        <div className="absolute top-10 right-10 w-32 h-32 bg-secondary-100 rounded-full opacity-50 blur-3xl"></div>
        <div className="absolute bottom-10 left-10 w-40 h-40 bg-primary-100 rounded-full opacity-50 blur-3xl"></div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search AC parts by name, code, or brand..."
              defaultValue={search || ''}
              onChange={(e) => setSearchQuery(e.target.value)}
              onKeyDown={handleSearch}
              className="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-primary-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-100 transition-all outline-none text-lg"
            />
          </div>
        </motion.div>
            ...
            <div className="mt-4 flex items-center gap-2 flex-wrap">
              ...
              {search && (
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
                  Search: {search}
                  <button onClick={() => handleSubCategoryFilter(null)} className="hover:bg-primary-200 rounded-full p-0.5">
                    <X className="h-3 w-3" />
                  </button>
                </span>
              )}
              {subCategory && (
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-primary-100 text-primary-700 rounded-full text-sm">
                  Type: {SUB_CATEGORIES.ac.find(s => s.id === subCategory)?.name}
                  <button onClick={() => handleSubCategoryFilter(null)} className="hover:bg-primary-200 rounded-full p-0.5">
                    <X className="h-3 w-3" />
                  </button>
                </span>
        ...
        {loading && (
          <div className="text-center py-20">
            ...
            <p className="mt-4 text-neutral-600 font-medium">Loading AC parts...</p>
          </div>
        )}
          ...
          <>
            ...
            >
              {parts.map((part) => (
                ...
                >
                  {/* Image */}
                  <div className="aspect-square bg-gradient-to-br from-neutral-50 to-primary-50 relative overflow-hidden">
                    <img
        ...
        {!loading && parts.length === 0 && (
          ...
          >
            ...
            <button
              onClick={() => window.location.href = '/services/ac-spare-parts'}
              className="px-8 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition font-medium shadow-lg"
            >
              View All AC Parts
            </button>
          </motion.div>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-br from-primary-600 to-primary-700 text-white py-16 mt-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-50 mb-8">
              Our expert team is here to help you find the right AC spare part. Contact us now!
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a
                href={`tel:${PHONE}`}
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary-600 rounded-lg font-semibold hover:bg-primary-50 transition-all shadow-lg hover:shadow-xl"
              >
                <Phone className="h-5 w-5" />
                Call Us Now
              </a>
              <a
                href={`https://wa.me/${WHATSAPP}?text=Hi, I need help finding an AC spare part`}
                target="_blank"
      ...
      <section className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <Link
              href="/services/refrigerator-spare-parts"
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Browse fridge spare parts</p>
                </div>
              </div>
            </Link>
            <Link
